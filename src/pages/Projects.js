          ...
          <div className="col-md-5">
            <div className="position-relative project">
              ...
              <div className="project-content">
                ...
                <hr />
                <p>
                  Netmeds is an online pharmacy that offers customers the
                  convenience of ordering health products online via a simple
                  process.
                </p>
                <br />
          ...
          <div className="col-md-5">
            <div className="position-relative project">
              ...
              <div className="project-content">
                ...
                <hr />
                <p>
                  Coursera is an online education website which provides courses
